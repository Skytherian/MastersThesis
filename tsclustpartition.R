...
setwd("/home/scyther/Documents/clustergi/ts/partitional/")
cl <- makeCluster(6)
...
str1<-paste("Time Series Partitional Clustering","using"
...
pc <- tsclust(synthetic_control, type = "partitional", k = 6, 
              distance = "dtw2", centroid = i, 
              seed = 3247L, trace = TRUE,
              args = tsclust_args(dist = list(window.size = 6L)))
plot(pc)
ggsave("pc.png",width =9,height=5.064,dpi=350) 
